...
tf.app.flags.DEFINE_integer('vocab_size', 150, 'Vocabulary size')
tf.app.flags.DEFINE_integer('num_classes', 6, 'Number of class to consider')
#tf.app.flags.DEFINE_integer('sent_len', 257, 'Input sentence length (after padding)')
tf.app.flags.DEFINE_integer('sent_len', 1763, 'Input sentence length (after padding)')
