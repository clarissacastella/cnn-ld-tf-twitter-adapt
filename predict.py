...
#Loaded data with 1077 examples. 100 examples per batch will be used.
...
def main(argv=None):
    ...
    tf.app.flags.DEFINE_string('train_dir', os.path.join(this_dir, 'model', 'alegre'), 'Where to read model')
    FLAGS._parse_flags()

    text = u"a bing and large and lovely happy sentence in english"
